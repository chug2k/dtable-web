...
module.exports = function(webpackEnv) {
  ...
  const publicPath = isEnvProduction ? paths.servedPath : isEnvDevelopment && 'http://127.0.0.1:3001/assets/bundles/';
  ...
  return {
    ...
    entry: {
      ...
      dtableFormView: [
        isEnvDevelopment && require.resolve('react-dev-utils/webpackHotDevClient'),
        paths.appSrc + "/dtable-shared-form-view.js",
      ].filter(Boolean),
      dtableSharedRowView: [
        isEnvDevelopment && require.resolve('react-dev-utils/webpackHotDevClient'),
        paths.appSrc + "/dtable-shared-row-view.js",
      ].filter(Boolean),
      dtableEditFormView: [
        isEnvDevelopment && require.resolve('react-dev-utils/webpackHotDevClient'),
        paths.appSrc + "/dtable-edit-form-view.js",
      ].filter(Boolean)
    },
    output: {
      // The build folder.
      ...
      publicPath : isEnvDevelopment ? publicPath : false,
    ...
    plugins: [
      ...
      new webpack.ContextReplacementPlugin(/moment[\/\\]locale$/, /zh-cn|en|fr|de/),
