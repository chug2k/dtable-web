...
class WorkWeixinDepartments extends Component {
  ...
  getWorkWeixinDepartmentsList = (departmentID) => {
    dtableWebAPI.adminListWorkWeixinDepartments(departmentID).then((res) => {
      if (!departmentID) {
  ...
  getWorkWeixinDepartmentMembersList = (department_id) => {
    ...
    dtableWebAPI.adminListWorkWeixinDepartmentMembers(department_id, {fetch_child: true}).then((res) => {
  ...
  onSubmit = () => {
    ...
    dtableWebAPI.adminAddWorkWeixinUsersBatch(userList).then((res) => {
      this.setState({
        newUsersTempObj: {},
        isCheckedAll: false,
      });
  ...
  onImportDepartmentSubmit = () => {
    ...
    dtableWebAPI.adminImportWorkWeixinDepartment(importDepartment.id).then((res) => {
      this.setState({
        isMembersListLoading: true,
