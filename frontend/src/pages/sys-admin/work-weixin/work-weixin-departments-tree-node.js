...
class WorkWeixinDepartmentsTreeNode extends Component {
  ...
  render() {
    ...
    let toggleClass = classNames({
      'folder-toggle-icon dtable-font dtable-icon-drop-down': department.children && this.state.isChildrenShow,
      'folder-toggle-icon dtable-font dtable-icon-right-slide': department.children && !this.state.isChildrenShow,
    });
