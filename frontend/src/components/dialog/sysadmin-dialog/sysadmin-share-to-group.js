...
class SysAdminShareToGroup extends React.Component {
  ...
  loadOptions = () => {
    dtableWebAPI.shareableGroups().then((res) => {
      this.options = [];
  ...
  listSharedGroups = () => {
    ...
    dtableWebAPI.sysAdminListRepoSharedItems(repoID, 'group').then((res) => {
  ...
  shareToGroup = () => {
    ...
    dtableWebAPI.sysAdminAddRepoSharedItem(repoID, 'group', groups, this.state.permission).then(res => {
      let errorMsg = [];
  ...
  deleteShareItem = (groupID) => {
    let repoID = this.props.repoID; 
    dtableWebAPI.sysAdminDeleteRepoSharedItem(repoID, 'group', groupID).then(() => {
      this.setState({
  ...
  onChangeUserPermission = (item, permission) => {
    ...
    dtableWebAPI.sysAdminUpdateRepoSharedItemPermission(repoID, 'group', groupID, permission).then(() => {
