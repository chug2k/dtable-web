  ...
  render() {
    return (
      <div className="rename-container">
        ...
        />
        <button className="btn btn-secondary dtable-font dtable-icon-confirm confirm" onClick={this.onRenameConfirm}></button>
        <button className="btn btn-secondary dtable-font dtable-icon-cancel cancel" onClick={this.onRenameCancel}></button>
      </div>
    );
  }
}
