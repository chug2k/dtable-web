          ...
          <div id="mainContainer">
            ...
            <div id="secondaryToolbar" className="secondaryToolbar hidden doorHangerRight sf-hide">
              <div id="secondaryToolbarButtonContainer">
                ...
                <button id="secondaryViewBookmark" className="secondaryToolbarButton bookmark visibleSmallView" title="Current view (copy or open in new window)" tabIndex="55" data-l10n-id="bookmark">
              ...
              <div id="toolbarContainer">
                <div id="toolbarViewer" className="sf-hide">
                  ...
                  <div id="toolbarViewerRight">
                    ...
                    <button id="viewBookmark" className="toolbarButton bookmark hiddenSmallView" title="Current view (copy or open in new window)" tabIndex="35" data-l10n-id="bookmark">
                      <span data-l10n-id="bookmark_label">Current View</span>
                    </button>
